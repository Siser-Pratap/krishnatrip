...
//  })
  ...
  return (
        ...
        // <div ref={main} className='fixed w-full top-0 bg-red-600 m-0 bg-inherit min-w-40 '>
        //   <div className='hello flex justify-between items-center p-2'>
        //     <Link href="/" >
